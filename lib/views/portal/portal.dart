...
class _StickHeader extends StatelessWidget{
  @override
  Widget build(BuildContext context) {
    // TODO: implement build
...
class _Banner extends StatelessWidget{
  ...
  Widget build(BuildContext context) {
    ...
    return Stack(
      children: <Widget>[
        Image.asset('assets/images/banner.png',fit:BoxFit.cover, height: 160,),
        GestureDetector(
            onTap: (){
              print('address click');
            },
...
class _SearchIem extends StatelessWidget {
  _SearchIem(this.name);
